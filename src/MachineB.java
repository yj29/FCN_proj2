...
public class MachineB {
    ...
    /**
     * Method that helps receiving the packet from the URN
     *
     * @param packet
     */
    ...
    /**
     * Thsi method processes the packet recevied
     * It checks if the packet is correct or corrupt or duplicate
     * Based on the nature of the packet it takes appropriate actions
     * and prepares the ack accordingly.
     *
     * @return
     */
    ...
    /**
     * This method prepares the ack message to be sent
     * It takes the ack # as input which is generated by the processPacket
     * based on the logic which checks if packet received is correct or not
     *
     * @param ackNumber
     * @return
     */
    ...
    /**
     * Mehod that checks the checksum
     *
     * @return
     */
